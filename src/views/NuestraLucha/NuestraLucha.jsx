      ...
      <section className="nuestra-lucha-content py-5">
        <Container>
          ...
          <Row className="mt-5">
            ...
            <Col sm={12} md={6} lg={4} className='d-flex align-items-center'>
              <div className="d-flex justify-content-center">
                <img src={img1} alt="" loading='lazy' className='img-fluid' />
          ...
          <div className="mt-5 text-center rounded p-4 shadow bannerEpec">
            ...
            <Link to="/defendamos-epec" className="px-2 py-1 mt-3 estiloBotonClaro">Ver más</Link>
          </div>
