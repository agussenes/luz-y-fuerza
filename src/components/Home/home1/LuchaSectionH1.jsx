                ...
                <div className="py-5">
                    <Container>
                        <Row className="align-items-center">
                            <Col >
                                <h2 className="mb-4 display-4"> <span style={{ fontWeight: 'bold', textDecoration: 'underline' }}>Desde 1944</span>, Defendiendo un Sindicato participativo y plural en permanente transformación.</h2>
                                <div className="d-flex gap-2">
                                    <Link className='estiloBotonClaro px-4' to={'/nuestra-lucha'} style={{ fontSize: '1.6rem' }}>Nuestra lucha</Link>
