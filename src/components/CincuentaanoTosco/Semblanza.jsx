...
import './Semblanza.css';


import imgS from '../../assets/images/cincuentaAnAT/semblanzaImg.webp';
    ...
    return (
        <>
            <section className="container">
                <Container className='m-0 p-0 h-100 py-4'>
                    <h1 className='fw-bold text-uppercase mb-2  text-center'>Semblanza a Agustín Tosco</h1>
                    <p className='text-center bajadaSemblanza'>El 5 de noviembre, en el panteón de Unión Eléctrica, la voz de <strong>Juan Cruz Taborda Varela</strong> detuvo el tiempo. Su semblanza hizo latir de nuevo la memoria colectiva: militancia apretada, mística encendida, abrazos que reconocen en Agustín una bandera que no se arrea. Compartimos, a continuación, el escrito que abrazó a todos y a todas. </p>
